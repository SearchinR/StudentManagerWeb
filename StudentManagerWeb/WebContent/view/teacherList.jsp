	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var education=$("#add_education").textbox("getText");
							var data = {clazzid:clazzid, name:name,sex:sex,education:education,mobile:phone,qq:qq,password:password};
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$("#add_education").textbox('setValue', "");
	  ...
	  //下拉框通用属性
	  	...
	  	$("#editDialog").dialog({
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var education=$("#edit_education").textbox("getText");
							var data = {id:id, clazzid:clazzid, name:name,sex:sex,education:education,mobile:phone,qq:qq};
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$("#edit_education").textbox('setValue', "");
										//重新刷新页面数据
							  			$('#dataList').datagrid("reload");
							  			$('#dataList').datagrid("uncheckAll");
			...
			onBeforeOpen: function(){
				...
				$("#edit_education").textbox('setValue', selectRow.education);
	...
	<div id="addDialog" style="padding: 10px;">  
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		...
	    		<tr>
	    			<td>学历:</td>
	    			<td colspan="4"><input id="add_education" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="education" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		...
	    		<tr>
	    			<td>学历:</td>
	    			<td colspan="4"><input id="edit_education" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="education"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
