	    ...
	    series: [
	        {
	            ...
	            data:[
	                {value:<%=request.getAttribute("courseNum")%>, name:'课程数量', selected:true},
	                {value:<%=request.getAttribute("teacherNum")%>, name:'老师数量'},
	                {value:<%=request.getAttribute("clazzNum")%>, name:'班级数量'},
	                {value:<%=request.getAttribute("studentNum")%>, name:'学生数量'}
	        ...
	        },
	        {
	            ...
	            data:[
	                ...
	                {value:<%=request.getAttribute("YanNum")%>, name:'研究生'},
	                {value:<%=request.getAttribute("BenNum")%>, name:'本科生'},
	                {value:<%=request.getAttribute("clazzNum")%>, name:'其他'},
