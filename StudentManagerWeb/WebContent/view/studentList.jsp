	...
	$(function() {	
	    ...
	    $("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_address").val('setValue',selectRow.id);
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>地址:</td>
	    			<td><input id="add_address" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="address"  /></td>
	    		</tr>
	    		<tr>
	    			<td>班级:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>地址:</td>
	    			<td><input id="edit_address" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="address"  /></td>
	    		</tr>
	    		<tr>
	    			<td>班级:</td>
