...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"6","icon":"","menuname":"课程管理",
							"menus":[
									{"menuid":"44","menuname":"课程列表","icon":"icon-house","url":"CourseServlet?method=toCourseListView"}
								]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"8","icon":"","menuname":"学生成绩管理",
							"menus":[
									{"menuid":"49","menuname":"成绩列表","icon":"icon-house","url":"ScoreServlet?method=toScoreListView"}
								]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
